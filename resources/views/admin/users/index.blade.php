...
<div class="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <!-- Add New User Button -->
    <div class="mb-4">
        <a href="{{ route('users.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">Adicionar novo usuário</a>
    </div>
                ...
                @forelse ($users as $user)
                    <tr class="border border-gray-300 hover:bg-gray-100 transition">
                        ...
                        <td class="py-2 px-4 border border-gray-300 flex space-x-2">
                            ...
                            <a href="{{ route('users.show', $user->id) }}" class="text-blue-500 hover:underline">Detalhes</a>
                        </td>
                    </tr>
                @empty
                    <tr>
